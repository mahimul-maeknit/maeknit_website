...
const interestToOdooTagMap = {
  ...
  "Swatching": "Swatching",
  "3D Sampling": "3D Sampling",
  "Knit Programming": "Programming",
};
  ...
  return new Promise((resolve, reject) => {
    ...
    common.methodCall(
      ...
      (authErr, uid) => {
        ...
        const isCompany = leadData.identities.includes("Brand", "Vendor", "Factory" );
        const primaryIdentity = leadData.identities.find((id) => identityToContactTypeMap[id]);
        const contactType = identityToContactTypeMap[primaryIdentity] || "individual";
